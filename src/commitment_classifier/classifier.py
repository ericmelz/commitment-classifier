...
class MessageClassifier:
    ...
    def classify(self, message: str, labels: list[str]) -> ClassificationResult:
        ...
        prompt = (
            ...
            f"- C1_BINDING binding commitments (example: I'll have it done by tomorrow)\n"
            f"- C2_SOFT soft commitment.  co(example: I'll do it if I have time)\n"
            f"- D1_DIRECTIVE directive\n"
            f"- P1_DECISION decision\n"
            f"- N1_NONE of the above\n"
